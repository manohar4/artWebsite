...
export default function Home() {
  ...
  const [initialAuthToken, setInitialAuthToken] = useState<string | undefined>()

  // Initialize Firebase on mount
  useEffect(() => {
    // Get initial auth token from environment or URL params
  ...
  return (
    <main className="min-h-screen relative">
      {/* Ethereal Shadow Full Page Background */}
          ...
          >
            ...
            <section id="contact" className="py-20 px-6 md:px-12 lg:px-20 relative">
              <div className="max-w-4xl mx-auto text-center">
                ...
                >
                  <Link
                    href="https://www.instagram.com/the___doodler"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg border-2 border-white text-white font-medium hover:bg-white hover:text-black transition-all duration-300"
                  >
