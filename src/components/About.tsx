...
const About = () => {
  ...
  return (
    <section id="about" className="relative min-h-[90vh] flex justify-center overflow-hidden">
      {/* Centered wrapper - image + content block */}
      <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row items-stretch">
        ...
        >
          <div className="relative w-full max-w-[420px] md:max-w-[480px] aspect-[4/5] rounded-lg overflow-hidden shadow-2xl">
            <Image
